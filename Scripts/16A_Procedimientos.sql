...
CREATE PROCEDURE dbo.spValores_Predeterminados 
 @intPrimero int = NULL,  
 @intSegundo int = 2,    
 @intTercero int = 3     
AS
...
EXECUTE spValores_Predeterminados 40, , 50           -- Error de sintaxis
...
CREATE PROCEDURE dbo.spMensaje_Error @intParametro int = NULL     
AS
...
-----------------------------------------------------------------------
Use AdventureWorks2012;
EXECUTE sp_recompile 'dbo.spVentas_Por_Producto'
GO
