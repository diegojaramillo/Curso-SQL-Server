...
-----------------------------------------------------------------------
1.1 Presione el botón "New Query" 
...
1.5 Seleccione la base de datos AdventureWorks2012
1.6 Presione "Parse"
...
2.1. Seleccione el texto de BusinessEntityID y FirstName y presione los botones "Increase Indent" 
     y "Decrease Indent"
2.2. Cambie el tamaño del tabulador con: Menú Tools, Options
2.3. Expanda "Text Editor", "All Languages", "Tabs"
2.4. Escriba 20 en "Tab size" y en "Indent size" 
...
6.1. En Object Explorer, expanda el servidor, Databases, la base de datos AdventureWorks, 
...
7.3. En la lista desplegable "Available Databases" seleccione AdventureWorks
