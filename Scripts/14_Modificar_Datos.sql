...
USE Norte
INSERT Clientes (IdCliente, Compania, ContactoNombre, ContactoTitulo,
...
USE Norte
SELECT Compania, ContactoNombre FROM Clientes WHERE IdCliente = 'TR'
...
INSERT Despachadores (Compania) VALUES ('Fitch & Mather')

SELECT * FROM Despachadores WHERE Compania = 'Fitch & Mather'

2.1 Uso de DEFAULT para una columna que permite valores default o null.

USE Norte
INSERT Despachadores (Compania, Telefono) VALUES ('Fitch & Mather', DEFAULT)
INSERT Despachadores (Compania, Telefono) VALUES ('Kenya Coffee Co.', DEFAULT)

SELECT * FROM Despachadores WHERE Compania = 'Kenya Coffee Co.'
