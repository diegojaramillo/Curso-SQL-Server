...
SELECT COUNT(IdPedido) Cantidad, IdDespachador 
FROM dbo.Pedidos
GROUP BY IdDespachador; 
...
select top 5 d.IdProducto, sum(d.Cantidad) from Pedidos_Detalles d inner join Pedidos p
