...
-----------------------------------------------------------------------
1.1 Borrar la BD Norte_2015

1. En Object explorer expanda la carpeta Databases y seleccione la BD Norte_2015
2. De un clic secundario en la BD Norte_2015 y luego en Delete
3. Seleccione cancelar puesto que no será borrada la BD si no sobrescrita en el 
   siguiente punto
   
1.2 Restaurar backup de la BD Norte_2015
...
1. En Object explorer de un clic secundario en la carpeta Databases y luego en 
   ...
   C. Presione el botón (...) al final de: From device
      ...
      ii. Presione el botón Add y seleccione el archivo backup en la ruta:
          \Curso_SQL\Norte_2015_Backup.bak
      iii. Presione OK
   ...
   E. Seleccione la página Optios a mano izquierda
      ...
      ii. En restore the database files as:
          Norte_2015_Data: \Curso_SQL\Norte_2015_Data.mdf
          Norte_2015_Log:  \Curso_SQL\Norte_2015_Log.ldf
